...
const POEM_CLOZE: Question[] = [
  ...
  v({
    question_id: "C4B_POEM_CLOZE_011",
    unit_id: "C4B_U1_NATURE",
    skill_id: "C4B_U1_POEM_RECITE",
    skill_name: "古诗补字",
    game_type: "poem_cloze",
    difficulty: 2,
    stem: "把字塞进高鼎《村居》的空格里：",
    feedback_correct: "草长莺飞、拂堤杨柳——春天放纸鸢的快乐都在这首诗里。",
    feedback_wrong: "再读：草长莺飞二月天，拂堤杨柳醉春烟。",
    game_data: {
      kind: "poem_cloze",
      template:
        "草长___飞二月天，拂___杨柳醉春烟。\n儿童散学归来早，忙趁东风放纸鸢。",
  ...
  v({
    question_id: "C4B_POEM_CLOZE_012",
    unit_id: "C4B_U1_NATURE",
    skill_id: "C4B_U1_POEM_RECITE",
    skill_name: "古诗补字",
    game_type: "poem_cloze",
    difficulty: 3,
    stem: "把字塞进叶绍翁《游园不值》的空格里：",
    feedback_correct: "一枝红杏出墙来——挡不住的春天，是千古名句。",
    feedback_wrong: "再读：春色满园关不住，一枝红杏出墙来。",
    game_data: {
      kind: "poem_cloze",
      template:
        "应怜屐齿印苍苔，小扣柴扉久不开。\n春色满___关不住，一枝红___出墙来。",
  ...
  v({
    question_id: "C4B_POEM_CLOZE_013",
    unit_id: "C4B_U1_NATURE",
    skill_id: "C4B_U1_POEM_RECITE",
    skill_name: "古诗补字",
    game_type: "poem_cloze",
    difficulty: 3,
    stem: "把字塞进翁卷《乡村四月》的空格里：",
    feedback_correct: "绿遍山原、子规声里——初夏江南农忙的画面。",
    feedback_wrong: "再读：绿遍山原白满川，子规声里雨如烟。",
    game_data: {
      kind: "poem_cloze",
      template:
        "绿___山原白满川，子规声里雨如___。\n乡村四月闲人少，才了蚕桑又插田。",
  ...
  v({
    question_id: "C4B_POEM_CLOZE_014",
    unit_id: "C4B_U1_NATURE",
    skill_id: "C4B_U1_POEM_RECITE",
    skill_name: "古诗补字",
    game_type: "poem_cloze",
    difficulty: 2,
    stem: "把字塞进杨万里《小池》的空格里：",
    feedback_correct: "小荷才露、蜻蜓早立——初夏小池的细腻一瞬。",
    feedback_wrong: "再读：小荷才露尖尖角，早有蜻蜓立上头。",
    game_data: {
      kind: "poem_cloze",
      template:
        "泉眼无声惜细流，树阴照水爱晴柔。\n小荷才露尖尖___，早有蜻___立上头。",
  ...
  v({
    question_id: "C4B_POEM_CLOZE_015",
    unit_id: "C4B_U1_NATURE",
    skill_id: "C4B_U1_POEM_RECITE",
    skill_name: "古诗补字",
    game_type: "poem_cloze",
    difficulty: 3,
    stem: "把字塞进白居易《池上》的空格里：",
    feedback_correct: "小娃撑艇、浮萍一道——偷采白莲的童趣写得活灵活现。",
    feedback_wrong: "再读：小娃撑小艇，偷采白莲回。",
    game_data: {
      kind: "poem_cloze",
      template: "小娃撑小___，偷采白___回。\n不解藏踪迹，浮萍一道开。",
      blanks: ["艇", "莲"],
      pool: ["艇", "莲", "船", "荷", "舟"],
    },
  }),
...
const SENTENCE_SHUFFLE: Question[] = [
  ...
  v({
    question_id: "C4B_SHUFFLE_011",
    unit_id: "C4B_U3_POETRY",
    skill_id: "C4B_U3_RHETORIC",
    skill_name: "古诗排序",
    game_type: "sentence_shuffle",
    difficulty: 2,
    stem: "按正确顺序点出孟浩然《春晓》前两句：",
    feedback_correct: "春眠不觉晓，处处闻啼鸟——睡得香甜，醒来满耳鸟鸣。",
    feedback_wrong: "先说睡（不觉晓），再说听见的鸟（闻啼鸟）。",
    game_data: {
      kind: "sentence_shuffle",
      tokens: ["春眠", "不觉", "晓", "处处", "闻", "啼鸟"],
      fullSentence: "春眠不觉晓，处处闻啼鸟",
    },
  }),
  v({
    question_id: "C4B_SHUFFLE_012",
    unit_id: "C4B_U3_POETRY",
    skill_id: "C4B_U3_RHETORIC",
    skill_name: "古诗排序",
    game_type: "sentence_shuffle",
    difficulty: 3,
    stem: "按正确顺序点出李白《望天门山》前两句：",
    feedback_correct: "天门中断楚江开，碧水东流至此回——气势磅礴的长江山水。",
    feedback_wrong: "先写山（天门中断），再写水（碧水东流）。",
    game_data: {
      kind: "sentence_shuffle",
      tokens: ["天门", "中断", "楚江", "开", "碧水", "东流", "至此", "回"],
      fullSentence: "天门中断楚江开，碧水东流至此回",
    },
  }),
  v({
    question_id: "C4B_SHUFFLE_013",
    unit_id: "C4B_U2_SCIENCE",
    skill_id: "C4B_U2_VOCAB",
    skill_name: "关联词组句",
    game_type: "sentence_shuffle",
    difficulty: 3,
    stem: "用关联词组句（'只要...就...'）：",
    feedback_correct: "只要 + 充分条件，就 + 必然结果。",
    feedback_wrong: "顺序：只要 / 我们 / 多多观察 / 就 / 能发现 / 大自然的 / 秘密。",
    game_data: {
      kind: "sentence_shuffle",
      tokens: ["只要", "我们", "多多观察", "就", "能发现", "大自然的", "秘密"],
      fullSentence: "只要我们多多观察，就能发现大自然的秘密",
    },
  }),
  v({
    question_id: "C4B_SHUFFLE_014",
    unit_id: "C4B_U2_SCIENCE",
    skill_id: "C4B_U2_VOCAB",
    skill_name: "关联词组句",
    game_type: "sentence_shuffle",
    difficulty: 3,
    stem: "用关联词组句（'如果...就...'）：",
    feedback_correct: "如果 + 假设，就 + 推断的结果。",
    feedback_wrong: "顺序：如果 / 明天 / 不下雨 / 我们 / 就 / 去 / 春游。",
    game_data: {
      kind: "sentence_shuffle",
      tokens: ["如果", "明天", "不下雨", "我们", "就", "去", "春游"],
      fullSentence: "如果明天不下雨，我们就去春游",
    },
  }),
  v({
    question_id: "C4B_SHUFFLE_015",
    unit_id: "C4B_U4_ANIMALS",
    skill_id: "C4B_U4_VOCAB",
    skill_name: "句子重排",
    game_type: "sentence_shuffle",
    difficulty: 2,
    stem: "把词块按正确顺序点亮组成《白鹅》风格的描写：",
    feedback_correct: "主谓宾完整：那只 / 白鹅 / 迈着 / 方步 / 走过 / 草地。",
    feedback_wrong: "定语 '那只' 在前，状语 '迈着方步' 修饰 '走'。",
    game_data: {
      kind: "sentence_shuffle",
      tokens: ["那只", "白鹅", "迈着", "方步", "走过", "草地"],
      fullSentence: "那只白鹅迈着方步走过草地",
    },
  }),
];

// ============================================================
//  修辞辨认（rhetoric）— C4 修辞画卷 cluster 真题
//  stem 里把句子用 "..." 引起来，后接"用了什么修辞？"，
//  RhetoricScrollPreview 的 adaptRhetoric 会抓引号里的句子做画卷题诗。
//  4 选 1（plain_choice），选项文本含修辞手法名（比喻/拟人/排比/夸张/反问/对偶/设问/反复）。
// ============================================================
const RHETORIC: Question[] = [
  v({
    question_id: "C4B_RHET_001",
    unit_id: "C4B_U3_POETRY",
    skill_id: "C4B_U3_RHETORIC",
    skill_name: "修辞辨认",
    game_type: "plain_choice",
    difficulty: 2,
    stem: '"天上的星星眨着眼睛，好像在跟我说悄悄话。" 用了什么修辞？',
    options: [
      { id: "a", text: "拟人" },
    ...
    feedback_correct: "对！'眨眼睛''说悄悄话'是人的动作，把星星当人来写——这是拟人。",
    feedback_wrong: "看动作：星星会'眨眼''说话'吗？这是把物当人写的拟人。",
    solution_steps: ["'眨着眼睛''说悄悄话'都是人的动作，作者把星星当成人来写，所以是拟人，不是比喻（句中没有把星星比作别的东西）。"],
  }),
  v({
    question_id: "C4B_RHET_002",
    unit_id: "C4B_U3_POETRY",
    skill_id: "C4B_U3_RHETORIC",
    skill_name: "修辞辨认",
    game_type: "plain_choice",
    difficulty: 2,
    stem: '"圆圆的荷叶像一把把碧绿的小伞，撑在水面上。" 用了什么修辞？',
    options: [
      { id: "a", text: "比喻" },
      { id: "b", text: "拟人", errorTag: "rhetoric_confusion" },
      { id: "c", text: "反问", errorTag: "rhetoric_confusion" },
      { id: "d", text: "对偶", errorTag: "rhetoric_confusion" },
    ],
    answer: { type: "choice", value: "a" },
    feedback_correct: "对！本体是荷叶，喻体是小伞，用'像'连起来——这是比喻。",
    feedback_wrong: "看有没有'像'：荷叶'像'小伞，本体+喻体齐全，是比喻。",
    solution_steps: ["本体'荷叶'+ 喻体'小伞'，用'像'连接，相似点是又圆又绿、能遮挡，所以是比喻。"],
  }),
  v({
    question_id: "C4B_RHET_003",
    unit_id: "C4B_U3_POETRY",
    skill_id: "C4B_U3_RHETORIC",
    skill_name: "修辞辨认",
    game_type: "plain_choice",
    difficulty: 3,
    stem: '"操场上，有的同学跳绳，有的同学踢球，有的同学跑步。" 用了什么修辞？',
    options: [
      { id: "a", text: "排比" },
      { id: "b", text: "比喻", errorTag: "rhetoric_confusion" },
    ...
    answer: { type: "choice", value: "a" },
    feedback_correct: "对！三个'有的同学……'结构相同、并列排开——这是排比。",
    feedback_wrong: "数一数：三个'有的同学+动作'结构相同，是排比。",
    solution_steps: ["三个'有的同学……'句式相同、内容相关、并列排开（3 个及以上），所以是排比，气势更强。"],
  }),
  v({
    question_id: "C4B_RHET_004",
    unit_id: "C4B_U3_POETRY",
    skill_id: "C4B_U3_RHETORIC",
    skill_name: "修辞辨认",
    game_type: "plain_choice",
    difficulty: 3,
    stem: '"李白《望庐山瀑布》中写道：飞流直下三千尺，疑是银河落九天。" 用了什么修辞？',
    options: [
      { id: "a", text: "夸张" },
      { id: "b", text: "设问", errorTag: "rhetoric_confusion" },
      { id: "c", text: "排比", errorTag: "rhetoric_confusion" },
      { id: "d", text: "反复", errorTag: "rhetoric_confusion" },
    ],
    answer: { type: "choice", value: "a" },
    feedback_correct: "对！'三千尺'把瀑布的高度故意放大，是夸张。",
    feedback_wrong: "瀑布真有三千尺吗？这是故意放大特征的夸张。",
    solution_steps: ["'三千尺'把瀑布的高度大大放大，这是夸张；'疑是银河落九天'是想象，整体突出瀑布的雄伟。"],
  }),
  v({
    question_id: "C4B_RHET_005",
    unit_id: "C4B_U3_POETRY",
    skill_id: "C4B_U3_RHETORIC",
    skill_name: "修辞辨认",
    game_type: "plain_choice",
    difficulty: 3,
    stem: '"这么美的风景，难道不值得我们好好爱护吗？" 用了什么修辞？',
    options: [
      { id: "a", text: "反问" },
      { id: "b", text: "设问", errorTag: "rhetoric_confusion" },
      { id: "c", text: "比喻", errorTag: "rhetoric_confusion" },
      { id: "d", text: "拟人", errorTag: "rhetoric_confusion" },
    ],
    answer: { type: "choice", value: "a" },
    feedback_correct: "对！用问句表达'应该爱护'的肯定意思，自己不答——这是反问。",
    feedback_wrong: "这是'明知故问'：用问句加强'应该爱护'的语气，且不需要回答，是反问。",
    solution_steps: ["反问是无疑而问、答案就在问句里：'难道不值得爱护吗'其实是说'一定要爱护'，比直接陈述更有力。设问会自问自答，这里没有回答。"],
  }),
  v({
    question_id: "C4B_RHET_006",
    unit_id: "C4B_U3_POETRY",
    skill_id: "C4B_U3_RHETORIC",
    skill_name: "修辞辨认",
    game_type: "plain_choice",
    difficulty: 4,
    stem: '"两个黄鹂鸣翠柳，一行白鹭上青天。" 用了什么修辞？',
    options: [
      { id: "a", text: "对偶" },
      { id: "b", text: "夸张", errorTag: "rhetoric_confusion" },
      { id: "c", text: "反问", errorTag: "rhetoric_confusion" },
      { id: "d", text: "设问", errorTag: "rhetoric_confusion" },
    ],
    answer: { type: "choice", value: "a" },
    feedback_correct: "对！'两个'对'一行'、'黄鹂'对'白鹭'，字数相等、结构相对——这是对偶。",
    feedback_wrong: "看上下两句：字数相等、词性相对（黄鹂对白鹭、翠柳对青天），是对偶。",
    solution_steps: ["上下两句字数相等、结构相同、词性相对：'两个'对'一行'、'黄鹂'对'白鹭'、'鸣翠柳'对'上青天'，这是对偶。"],
  }),
  v({
    question_id: "C4B_RHET_007",
    unit_id: "C4B_U3_POETRY",
    skill_id: "C4B_U3_RHETORIC",
    skill_name: "修辞辨认",
    game_type: "plain_choice",
    difficulty: 4,
    stem: '"是谁把春天带到了人间？是辛勤的小燕子。" 用了什么修辞？',
    options: [
      { id: "a", text: "设问" },
      { id: "b", text: "反问", errorTag: "rhetoric_confusion" },
      { id: "c", text: "排比", errorTag: "rhetoric_confusion" },
      { id: "d", text: "比喻", errorTag: "rhetoric_confusion" },
    ],
    answer: { type: "choice", value: "a" },
    feedback_correct: "对！先自己问'是谁'，再自己答'是小燕子'——自问自答是设问。",
    feedback_wrong: "看有没有自答：先问'是谁'再答'是小燕子'，自问自答是设问（反问是不需要回答的）。",
    solution_steps: ["设问是自问自答、为了引起注意：先问'是谁把春天带到人间'，紧接着自己回答'是小燕子'。反问则不作回答，这是两者的区别。"],
  }),
  v({
    question_id: "C4B_RHET_008",
    unit_id: "C4B_U3_POETRY",
    skill_id: "C4B_U3_RHETORIC",
    skill_name: "修辞辨认",
    game_type: "plain_choice",
    difficulty: 4,
    stem: '"盼望着，盼望着，东风来了，春天的脚步近了。" 用了什么修辞？',
    options: [
      { id: "a", text: "反复" },
      { id: "b", text: "对偶", errorTag: "rhetoric_confusion" },
      { id: "c", text: "夸张", errorTag: "rhetoric_confusion" },
      { id: "d", text: "比喻", errorTag: "rhetoric_confusion" },
    ],
    answer: { type: "choice", value: "a" },
    feedback_correct: "对！'盼望着'连说两遍，强调期盼的心情——这是反复。",
    feedback_wrong: "看重复：'盼望着'一连说了两次，故意重复来强调，是反复。",
    solution_steps: ["'盼望着，盼望着'同一个词语接连重复出现，用来强调盼望春天的急切心情，这是反复。'春天的脚步'另有拟人意味，但反复是这句最突出的手法。"],
  }),
  v({
    question_id: "C4B_RHET_009",
    unit_id: "C4B_U3_POETRY",
    skill_id: "C4B_U3_RHETORIC",
    skill_name: "修辞辨认",
    game_type: "plain_choice",
    difficulty: 3,
    stem: '"什么样的爪子才算锋利？看，老鹰的爪子又弯又尖。" 用了什么修辞？',
    options: [
      { id: "a", text: "设问" },
      { id: "b", text: "反问", errorTag: "rhetoric_confusion" },
      { id: "c", text: "比喻", errorTag: "rhetoric_confusion" },
    ...
    answer: { type: "choice", value: "a" },
    feedback_correct: "对！先问'什么样的爪子才算锋利'，再自己答'老鹰的爪子又弯又尖'——自问自答是设问。",
    feedback_wrong: "看有没有自答：先提问再自己回答，自问自答是设问；反问是不需要回答的。",
    solution_steps: ["设问是自问自答、为了引起注意：先问'什么样的爪子才算锋利'，紧接着自己回答'老鹰的爪子又弯又尖'。反问则不作回答，这是两者的区别。"],
  }),
  v({
    question_id: "C4B_RHET_010",
    unit_id: "C4B_U3_POETRY",
    skill_id: "C4B_U3_RHETORIC",
    skill_name: "修辞辨认",
    game_type: "plain_choice",
    difficulty: 3,
    stem: '"走呀走，走呀走，我们终于走到了山顶。" 用了什么修辞？',
    options: [
      { id: "a", text: "反复" },
      { id: "b", text: "排比", errorTag: "rhetoric_confusion" },
      { id: "c", text: "对偶", errorTag: "rhetoric_confusion" },
      { id: "d", text: "比喻", errorTag: "rhetoric_confusion" },
    ],
    answer: { type: "choice", value: "a" },
    feedback_correct: "对！'走呀走'接连重复，强调路途之长——这是反复。",
    feedback_wrong: "看重复：'走呀走'一连说了两次，故意重复来强调，是反复（排比要 3 个结构相同的句子）。",
    solution_steps: ["'走呀走，走呀走'同一短语接连重复出现，强调走的时间长、路途远，这是反复。排比需要三个及以上结构相同的句子，这里不是。"],
  }),
  v({
    question_id: "C4B_RHET_011",
    unit_id: "C4B_U3_POETRY",
    skill_id: "C4B_U3_RHETORIC",
    skill_name: "修辞辨认",
    game_type: "plain_choice",
    difficulty: 4,
    stem: '"绿树村边合，青山郭外斜。" 用了什么修辞？',
    options: [
      { id: "a", text: "对偶" },
      { id: "b", text: "夸张", errorTag: "rhetoric_confusion" },
      { id: "c", text: "设问", errorTag: "rhetoric_confusion" },
      { id: "d", text: "反复", errorTag: "rhetoric_confusion" },
    ],
    answer: { type: "choice", value: "a" },
    feedback_correct: "对！'绿树'对'青山'、'村边'对'郭外'，字数相等、结构相对——这是对偶。",
    feedback_wrong: "看上下两句：字数相等、词性相对（绿树对青山、村边对郭外），这是对偶。",
    solution_steps: ["上下两句字数相等、结构相同、词性相对：'绿树'对'青山'、'村边'对'郭外'、'合'对'斜'，这是对偶。"],
  }),
  v({
    question_id: "C4B_RHET_012",
    unit_id: "C4B_U3_POETRY",
    skill_id: "C4B_U3_RHETORIC",
    skill_name: "修辞辨认",
    game_type: "plain_choice",
    difficulty: 3,
    stem: '"教室里静得连一根针掉在地上都听得见。" 用了什么修辞？',
    options: [
      { id: "a", text: "夸张" },
      { id: "b", text: "拟人", errorTag: "rhetoric_confusion" },
      { id: "c", text: "排比", errorTag: "rhetoric_confusion" },
    ...
    answer: { type: "choice", value: "a" },
    feedback_correct: "对！针掉在地上其实听不见，这里故意放大'安静'的程度——这是夸张。",
    feedback_wrong: "真能听见针掉地上吗？这是故意把'安静'放大的夸张。",
    solution_steps: ["'连一根针掉在地上都听得见'故意把安静的程度大大放大（实际上听不见），用夸张突出教室非常安静。"],
  }),
  v({
    question_id: "C4B_RHET_013",
    unit_id: "C4B_U3_POETRY",
    skill_id: "C4B_U3_RHETORIC",
    skill_name: "修辞辨认",
    game_type: "plain_choice",
    difficulty: 2,
    stem: '"春天来了，小草从泥土里探出头来，好奇地张望着这个世界。" 用了什么修辞？',
    options: [
      { id: "a", text: "拟人" },
      { id: "b", text: "比喻", errorTag: "rhetoric_confusion" },
      { id: "c", text: "夸张", errorTag: "rhetoric_confusion" },
    ...
    answer: { type: "choice", value: "a" },
    feedback_correct: "对！'探出头''好奇地张望'是人的动作神态，把小草当人来写——这是拟人。",
    feedback_wrong: "看动作：小草会'探头''张望'吗？这是把物当人写的拟人，句中没有把小草比作别的东西。",
    solution_steps: ["'探出头来''好奇地张望'都是人的动作和神态，作者把小草当成人来写，所以是拟人，不是比喻。"],
  }),
  v({
    question_id: "C4B_RHET_014",
    unit_id: "C4B_U3_POETRY",
    skill_id: "C4B_U3_RHETORIC",
    skill_name: "修辞辨认",
    game_type: "plain_choice",
    difficulty: 4,
    stem: '"为什么花儿这样红？因为它吸足了阳光和雨露。" 用了什么修辞？',
    options: [
      { id: "a", text: "设问" },
      { id: "b", text: "反问", errorTag: "rhetoric_confusion" },
      { id: "c", text: "排比", errorTag: "rhetoric_confusion" },
    ...
    answer: { type: "choice", value: "a" },
    feedback_correct: "对！先问'为什么花儿这样红'，再自己答'因为吸足了阳光雨露'——自问自答是设问。",
    feedback_wrong: "看有没有自答：先问'为什么'再自己回答'因为……'，自问自答是设问（反问是不需要回答的）。",
    solution_steps: ["设问是自问自答、为了引起读者注意：先问'为什么花儿这样红'，紧接着回答'因为它吸足了阳光和雨露'。反问则不作回答，这是两者的区别。"],
  }),
];
