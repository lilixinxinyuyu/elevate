...
export const SEED_QUESTIONS_CHINESE_GLYPH: Question[] = [
  ...
  // ── 同偏旁归类 (续) ──
  g({
    question_id: "C4B_GLYPH_022",
    unit_id: G_U4,
    difficulty: 4,
    stem: '下面哪一组字都是 "月"(肉月旁) 旁, 跟身体有关?',
    options: [
      { id: "a", text: "脸 / 脖 / 肚 (都是身体部位)" },
      { id: "b", text: "脸 / 朋 / 期 (都带月)" },
      { id: "c", text: "脸 / 明 / 朝 (都带月)" },
      { id: "d", text: "脸 / 清 / 请 (都带青)" },
    ],
    answer: { type: "choice", value: "a" },
    solution_steps: ["脸/脖/肚 左边都是肉月旁(月), 跟身体部位有关。朋/期的'月'不表身体, 明/朝的'月'是月亮, 清/请根本不带月旁——每组都有反例, 只有 A 全对。"],
    game_data: { kind: "glyph_detective", hanzi: "脸", hanziDesc: "肉月旁(月): 跟身体部位有关 (脸/脖/肚/腿/胸)", optionEmojis: ["🧍", "👬", "🌙", "🎨"] },
  }),
  g({
    question_id: "C4B_GLYPH_023",
    unit_id: G_U4,
    difficulty: 4,
    stem: '下面哪一组字都是 "足"(足字旁) 旁, 跟脚的动作有关?',
    options: [
      { id: "a", text: "跑 / 跳 / 踢 (都用脚)" },
      { id: "b", text: "跑 / 包 / 抱 (都带包)" },
      { id: "c", text: "跑 / 捉 / 提 (都是动作)" },
      { id: "d", text: "跑 / 飞 / 爬 (都是动作)" },
    ],
    answer: { type: "choice", value: "a" },
    solution_steps: ["跑/跳/踢 左边都是足字旁(⻊), 是用脚的动作。B 的'包'不带偏旁、'抱'是提手旁, C 的'捉/提'是提手旁(用手), D 的'飞'不是足字旁、'爬'是爪字旁——每组都有反例, 只有 A 三个都是足旁的脚部动作。"],
    game_data: { kind: "glyph_detective", hanzi: "跳", hanziDesc: "足字旁(⻊): 跟脚的动作有关 (跑/跳/踢/踏/跨)", optionEmojis: ["🦵", "🎁", "✋", "🚶"] },
  }),
  g({
    question_id: "C4B_GLYPH_024",
    unit_id: G_U1,
    difficulty: 3,
    stem: '下面哪一组字都是 "宀"(宝盖头) 旁, 跟房屋有关?',
    options: [
      { id: "a", text: "家 / 室 / 宿 (都跟房屋有关)" },
      { id: "b", text: "家 / 字 / 学 (都带子)" },
      { id: "c", text: "家 / 安 / 实 (都带宀)" },
      { id: "d", text: "家 / 床 / 库 (都跟屋子有关)" },
    ],
    answer: { type: "choice", value: "a" },
    solution_steps: ["家/室/宿 上面都是宝盖头(宀), 本义都跟房屋住所有关。B 的'字/学'带宀但不表房屋, C 的'安/实'带宀却不表房屋, D 的'床/库'是广字头(广)不是宝盖头——每组都有反例, 只有 A 全对。"],
    game_data: { kind: "glyph_detective", hanzi: "室", hanziDesc: "宝盖头(宀): 多跟房屋/住所有关 (家/室/宿/宅/宫)", optionEmojis: ["🏠", "📝", "🛡️", "🏚️"] },
  }),
  g({
    question_id: "C4B_GLYPH_025",
    unit_id: G_U1,
    difficulty: 4,
    stem: '下面哪一组字都是 "雨"(雨字头) 旁, 跟天气有关?',
    options: [
      { id: "a", text: "雪 / 雷 / 霜 (都是天气现象)" },
      { id: "b", text: "雪 / 雨 / 两 (字形都像雨)" },
      { id: "c", text: "雪 / 晴 / 阴 (都是天气)" },
      { id: "d", text: "雪 / 需 / 雀 (都带雨字头)" },
    ],
    answer: { type: "choice", value: "a" },
    solution_steps: ["雪/雷/霜 上面都是雨字头(⻗), 都跟天气现象有关。B 的'两'不带雨字头, C 的'晴/阴'是日字旁、月旁不是雨字头, D 的'需/雀'虽形似但不表天气(雀是鸟)——只有 A 三个都是雨字头的天气字。"],
    game_data: { kind: "glyph_detective", hanzi: "雪", hanziDesc: "雨字头(⻗): 跟天气现象有关 (雪/雷/霜/雾/霞)", optionEmojis: ["❄️", "🌧️", "☀️", "🐦"] },
  }),
];
