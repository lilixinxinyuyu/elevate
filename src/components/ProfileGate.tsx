...
import { setDisplayName as cacheDisplayName, setStoredBirthday, setStoredGrade, setStoredSchool, useDisplayName } from "../lib/displayName";
...
export function ProfileGate() {
  ...
  const onSubmit = async (e: React.FormEvent) => {
    ...
    if (patch.school) setStoredSchool(patch.school);
    setMissing(r.missing ?? []);
    // toast 保存了多少字段
